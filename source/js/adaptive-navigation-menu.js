...
(function() {
  ...
  var mainNavigationMenuToggleBtn = document.querySelector(
    "." + MAIN_NAV_TOGGLE_CLASS
  );
  var mainNavigationMenuItem = mainNavigationMenu.querySelector(
    "." + MAIN_NAV_ITEM_CLASS
  );
  var mainNavigationMenuList = mainNavigationMenu.querySelector(
    "." + MAIN_NAV_LIST_CLASS
  );
